...
public class KeyboardMouse
{
	...
	public void handleframes() throws Exception
	{
		...
		ResultScreenshot.saveresult(driver,"handleframes");
	...
	public void handlealerts() throws Exception
	{
		...
		ResultScreenshot.saveresult(driver,"handlealerts");
	}
	
	@Test(enabled=false)
	public void mousedemo() throws Exception
	{
	...
	@Test(enabled=false)
	public void keyboarddemo() throws Exception
	{
